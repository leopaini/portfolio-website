    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://avatars.githubusercontent.com/u/30599795?v=4"
      ...
      >
        ...
        <span className="font-bold">frontend developer</span> with more than{" "}
      ...
      >
        ...
        <a
          target="_blank"
          href="https://linkedin.com/in/lpaini"
        ...
        <a
          target="_blank"
          href="https://github.com/leopaini"
